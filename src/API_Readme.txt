...
📝 Observações sobre os Testes
    ...
    Substitua {seu_token_jwt} pelo token recebido após login
    Substitua os IDs de exemplo pelos IDs reais dos filmes
    Para testes de admin, troque o isAdmin para 1
    Todos os endpoints que requerem autenticação precisam do header Authorization: Bearer {token}
    Os testes podem ser executados via Postman, Insomnia ou qualquer cliente HTTP
    Para testes locais, a API deve estar rodando em http://localhost:8080
...
🚀 Como Executar
    ...
    Configure o MongoDB localmente ou atualize a URL de conexão no application.properties
    Execute o comando:
